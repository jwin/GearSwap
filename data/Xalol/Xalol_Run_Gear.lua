function user_setup()
	...
	state.Weapons:options('Aettir','Montante','DualWeapons')
	
	state.ExtraDefenseMode = M{['description']='Extra Defense Mode','None','MP'}

	gear.enmity_jse_back = {name="Ogma's cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10'}}
	gear.stp_jse_back = gear.enmity_jse_back
	gear.da_jse_back = gear.enmity_jse_back
	...
	send_command('bind !q gs c weapons Aettir;gs c update')
	send_command('bind ^q gs c weapons Montante;gs c update')
...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Staunch Tathlum",
	     head="Fu. Bandeau +1",neck="Unmoving Collar +1",ear1="Friomisi Earring",ear2="Cryptic Earring",
	     body="Emet Harness +1",hands="Futhark Mitons",ring1="Petrov Ring",ring2="Supershear Ring",
		 back=gear.enmity_jse_back,legs="Erilaz Leg Guards"}
    ...
    sets.Enmity.DT = {ammo="Staunch Tathlum",
        ...
        body="Runeist Coat +1",hands=gear.herculean_dt_hands,ring1="Moonbeam Ring",ring2="Moonbeam Ring",
        back="Solemnity Cape",waist="Flume Belt +1",legs="Erilaz Leg Guards",feet="Erilaz Greaves +1"}
    ...
    sets.precast.JA['Lunge'] = {ammo="Seeth. Bomblet +1",
        head=gear.herculean_wsd_head,neck="Eddy Necklace",ear1="Friomisi Earring",
        body="Samnuha Coat",hands="Leyline Gloves",ring1="Shiva Ring",ring2="Acumen Ring",
        back="Evasionist's Cape",waist="Eschan Stone",legs=gear.herculean_ta_legs,feet=gear.herculean_ta_feet}
    ...
    sets.precast.FC = {ammo="Sapience Orb",
    	head="Runeist Bandeau +1",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
    	hands="Leyline Gloves",ring1="Rahab Ring",ring2="Kishar Ring",
        back="Solemnity Cape",waist="Flume Belt +1",legs="Ayanmo Cosciales +2",feet="Carmine Greaves"}
	...
	sets.precast.WS = {ammo="Cheruski Needle",
            ...
            body="Adhemar Jacket",hands="Meg. Gloves +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
            back="Evasionist's Cape",waist="Fotia Belt",legs="Meg. Chausses +2",feet=gear.herculean_ta_feet}
	...
	sets.precast.WS.HighAcc = {ammo="Seeth. Bomblet +1",
            ...
            body="Ayanmo Corazza +2",hands="Meg. Gloves +2",ring1="Niqmaddu Ring",ring2="Regal Ring",
            back="Evasionist's Cape",waist="Fotia Belt",legs="Meg. Chausses +2",feet=gear.herculean_acc_feet}
    ...
    sets.precast.WS['Dimidiation'] = set_combine(sets.precast.WS,{legs=gear.herculean_ta_legs,feet=gear.herculean_ta_feet})
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.midcast.FastRecast,{
    	head="Erilaz Galea +1",neck="Incanter's Torque",ear1="Andoaa Earring",
	...
	sets.defense.MDT = {ammo="Yamarang",
        ...
        body="Runeist Coat +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Shadow Ring",
	...
	sets.defense.MDT_HP = {ammo="Staunch Tathlum",
        ...
        body="Runeist Coat +1",hands=gear.herculean_dt_hands,ring1="Moonbeam Ring",ring2="Moonbeam Ring",
        back="Solemnity Cape",waist="Engraved Belt",legs="Erilaz Leg Guards",feet="Erilaz Greaves +1"}
	...
	sets.defense.MEVA_HP = {ammo="Staunch Tathlum",
        head="Erilaz Galea +1",neck="Warder's Charm +1",ear1="Odnowa Earring +1",ear2="Sanare Earring",
        body="Runeist Coat +1",hands="Erilaz Gauntlets +1",ring1="Moonbeam Ring",ring2="Moonbeam Ring",
    ...
    sets.engaged = {ammo="Ginsen",
            head="Futhark Bandeau +1",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
    ...
    sets.engaged.DTLite = {ammo="Staunch Tathlum",
            ...
            body="Ayanmo Corazza +2",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Warden's Ring",
            back="Evasionist's Cape",waist="Windbuffet Belt +1",legs="Meg. Chausses +2",feet=gear.herculean_ta_feet}
