...
function user_setup()
	...
	state.Weapons:options('Kanaria','LowBuff','MagicWeapons','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcKatana','ProcClub','ProcStaff')
	
    state.ExtraMeleeMode = M{['description']='Extra Melee Mode', 'None','SuppaBrutal','DWEarrings','DWMax'}
	
	gear.wsd_jse_back = { name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}
	gear.da_jse_back = { name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}}
	
	send_command('bind ^` input /ja "Innin" <me>;gs c set Stance Innin')
    send_command('bind !` input /ja "Yonin" <me>;gs c set Stance Yonin')
	send_command('bind @` gs c cycle SkillchainMode')
	send_command('bind !q gs c set WeaponskillMode Proc;gs c set CastingMode Proc;gs c update')
	send_command('bind ^q gs c set WeaponskillMode Normal;gs c set CastingMode Normal;gs c update')
...
function init_gear_sets()
    ...
    sets.precast.Step = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Erudition Necklace",ear1="Zennaroi Earring",ear2="Telos Earring",
        body="Mummu Jacket +2",hands="Adhemar Wristbands",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
    ...
    sets.precast.Flourish1 = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Erudition Necklace",ear1="Gwati Earring",ear2="Digni. Earring",
    ...
    sets.precast.FC = {ammo="Impatiens",
		head=gear.herculean_wsd_head,neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
		body="Samnuha Coat",hands="Leyline Gloves",ring1="Rahab Ring",ring2="Kishar Ring",}
	...
	--sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {ammo="Yamarang",head="Ynglinga Sallet",neck="Erudition Necklace",ear1="Zennaroi Earring",ear2="Telos Earring",body="Mummu Jacket +2",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",waist="Olseni Belt",legs="Hiza. Hizayoroi +2",feet=gear.herculean_acc_feet})
	
	sets.precast.WS.Proc = {ammo="Togakushi Shuriken",
        head="Ynglinga Sallet",neck="Erudition Necklace",ear1="Zennaroi Earring",ear2="Telos Earring",
    ...
    sets.precast.WS['Blade: Jin'] = set_combine(sets.precast.WS, {head="Adhemar Bonnet",ammo="Yetshila",head="Adhemar Bonnet",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",waist="Grunfeld Rope",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
	...
	sets.midcast.Utsusemi = set_combine(sets.midcast.NinjutsuBuff, {back="Andartia's Mantle"})
    ...
    sets.idle = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Odnowa Earring +1",
        body="Adhemar Jacket",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Gelatinous Ring +1",
        back="Moonbeam Cape",waist="Flume Belt +1",legs=gear.herculean_ta_legs,feet=gear.herculean_ta_feet}
    ...
    sets.defense.MDT = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
    ...
    sets.engaged = {ammo="Togakushi Shuriken",
        head="Adhemar Bonnet",neck="Erudition Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
        body="Adhemar Jacket",hands="Floral Gauntlets",ring1="Petrov Ring",ring2="Epona's Ring",
        back=gear.da_jse_back,waist="Windbuffet Belt +1",legs=gear.herculean_ta_legs,feet="Hizamaru Sune-ate +1"}
    sets.engaged.SomeAcc = {ammo="Seki Shuriken",
        head="Dampening Tam",neck="Erudition Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
    ...
    sets.engaged.Acc = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Erudition Necklace",ear1="Digni. Earring",ear2="Telos Earring",
    ...
    sets.engaged.Fodder = {ammo="Togakushi Shuriken",
        head="Dampening Tam",neck="Erudition Necklace",ear1="Dedition Earring",ear2="Brutal Earring",
        body="Ken. Samue",hands="Adhemar Wristbands",ring1="Petrov Ring",ring2="Epona's Ring",
        back=gear.da_jse_back,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
    sets.engaged.Crit = {ammo="Togakushi Shuriken",
        head="Mummu Bonnet +2",neck="Erudition Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
	...
	-- Weapons sets
	sets.weapons.Kanaria = {main="Kanaria",sub="Ochu"}
	sets.weapons.LowBuff = {main="Kanaria",sub="Blurred Knife +1"}
	...
	sets.weapons.ProcGreatKatana = {main="Melon Slicer",sub=empty}
	sets.weapons.ProcKatana = {main="Kanaria",sub=empty}
	sets.weapons.ProcClub = {main="Soulflayer's Wand",sub=empty}
	sets.weapons.ProcStaff = {main="Hapy Staff",sub=empty}
