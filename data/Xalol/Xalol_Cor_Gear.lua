...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {range="Compensator",
        ...
        body="Lanun Frac +1",hands="Chasseur's Gants +1",ring1="Defending Ring",ring2="Gelatinous Ring +1",
        back=gear.da_jse_back,waist="Flume Belt +1",legs="Desultor Tassets",feet=gear.herculean_dt_feet}
    ...
    sets.precast.WS['Leaden Salute'] = {ammo=gear.MAbullet,
        ...
        body="Samnuha Coat",hands="Leyline Gloves",ring1="Archon Ring",ring2="Acumen Ring",
    ...
    sets.precast.WS['Leaden Salute'].Acc = {ammo=gear.MAbullet,
        head="Pixie Hairpin +1",neck="Sanctity Necklace",ear1="Moonshade Earring",ear2="Friomisi Earring",
        body="Samnuha Coat",hands="Leyline Gloves",ring1="Archon Ring",ring2="Meghanada Ring",
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs="Lak. Trews +1",feet="Lanun Bottes +1"}
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs="Lak. Trews +3",feet="Lanun Bottes +3"}
    ...
    sets.midcast.RA.Acc = {ammo=gear.RAbullet,
        head="Meghanada Visor +2",neck="Iskur Gorget",ear1="Enervating Earring",ear2="Telos Earring",
        body="Laksa. Frac +3",hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Dingir Ring",
        back=gear.tp_ranger_jse_back,waist="Yemaya Belt",legs="Laksa. Trews +1",feet="Meg. Jam. +2"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Meg. Cuirie +2",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Gelatinous Ring +1",
        back="Moonbeam Cape",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet=gear.herculean_dt_feet}
	...
	-- Weapons sets
	sets.weapons.Default = {main="Kaja Blade",sub="Nusku Shield",range="Molybdosis"}
	...
	--sets.weapons.DualKustawi = {main="Kustawi +1",sub="Kustawi",range="Molybdosis"}
